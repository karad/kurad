 ...
 * Route top writer
 */
public class RouteLoginWriter extends DefaultWriter {
    ...
    public static String view(CrudSetting crudSetting) {
        ...
        // add crud routes
        String addRouteContent = RoutesTagTemplate.getRoutesTagLogin(crudSetting.getControllerPath() + "/" + crudSetting.getControllerClass(), crudSetting.getControllerClass() + crudSetting.getControllerSuffix(), crudSetting.getControllerPackage(), crudSetting.getModelClass(), crudSetting);
