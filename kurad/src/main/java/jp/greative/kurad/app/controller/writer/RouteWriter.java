 ...
 * Routes writer
 */
public class RouteWriter extends DefaultWriter {
    ...
    public static String view(CrudSetting crudSetting) {
        ...
        // add crud routes
        String addRouteContent = RoutesTagTemplate.getRoutesTagScaffold(crudSetting.getControllerPath() + "/" + crudSetting.getControllerClass(), crudSetting.getControllerClass(), crudSetting.getControllerPackage(), crudSetting.getModelClass(), crudSetting);
